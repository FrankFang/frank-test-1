<template>
  <div class="gulu-date-range-picker" style="border: 1px solid red;" ref="wrapper">
    <g-popover ref="popover" position="bottom" :container="popoverContainer" @open="onOpen">
      ...
      <template slot="content">
        <div :class="c('pop')" @selectstart.prevent>
          <div :class="c('pickers')">
            <div :class="c('picker1')">
              <div class="gulu-date-range-picker-nav">
              ...
              <div class="gulu-date-range-picker-panels">
                <div class="gulu-date-range-picker-content">
          ...
          <div class="gulu-date-range-picker-actions">
...
export default {
  ...
  methods: {
    c(...classNames) {
      return classNames.map(className => `gulu-date-range-picker-${className}`);
    },
    onInput(value) {
